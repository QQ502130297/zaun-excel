...
import com.temu.zaun.excel.annocation.ExportSpecification;
...
public class ExportSpecificationResolver<QUERY, DATA, VIEW> implements TaskSpecificationResolver {
    ...
    public TaskSpec resolve(Processor processor) {
        ...
        List<Type> genericParamType = TypeUtil.getGenericParamType(processorClass, ExportProcessor.class);
    ...
    public boolean canResolve(Processor var1) {
        if (var1 instanceof ExportProcessor) {
            return true;
        }
        return false;
    }
